...
def check_synaptic_connetcion(cell):
	print(dir(cell))
	# print(dir(cell.synapses))
	print(dir(cell.synapses))
	for synapse in cell.synapses.synapse_list:
		print(synapse)
		print(synapse.synapseID)
		print(dir(synapse))
		print(synapse.tau_d_GABAA)
		print(synapse.tau_r_GABAA)
...
if __name__ == '__main__':
	...
	check_synaptic_connetcion(cells[0])
